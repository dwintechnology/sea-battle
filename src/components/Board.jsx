      ...
      {versionUser && (
        ...
        {/* {obj[player]?.map((el, index) => {
            if (
              ...
              if (
                obj[player][index].status[el.length -1 -(el.positionX - 2 + el.length - lastShoot.positionX)] == false
              ) {
                hit(
                  player,
                  index,
